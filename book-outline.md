The software and data in this repository are for the book _Celestial Calculations: A Gentle Introduction to Computational Astronomy_ by J. L. Lawrence, PhD and published by The MIT Press. The book contains the chapters listed below, while the software in this repository are programs that demonstrate the book's various concepts and algorithms.
