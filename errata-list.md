...
**Page 47, section 3.9, step 4**: the parenthetical note is incorrect. It should read “Note that adding $24^{h}$ means that the resulting LCT is for the *previous* day while subtracting 24^h^ means that the resulting LCT is for the *next* day.”
